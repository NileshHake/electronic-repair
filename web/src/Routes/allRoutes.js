...
import DeliveryAndPickUpBoyList from "../pages/DeliveryAndPickUpBoy/DeliveryAndPickUpBoyList";
import CustomerAddressList from "../pages/CustomerAddress/CustomerAddressList";
import CustomerList from "../pages/Customer/CustomerList";
import RoleList from "../pages/Roles/RolesList";
import BusinessList from "../pages/Business/BusinessList";
import RepairList from "../pages/Repairing/RepairingList";
import WorkflowList from "../pages/Workflow/WorkflowList";
import AccessoriesList from "../pages/Accessories/AccessoriesList";
import DeviceTypeList from "../pages/DeviceType/DeviceTypeList";
import RepairTypeList from "../pages/RepairType/RepairTypeList";
import SourceList from "../pages/Pages/Source/SourceList";
import ServiceList from "../pages/Services/ServiceList";
import DeviceModelList from "../pages/DeviceModel/DeviceModelList";
import ServiceTypeList from "../pages/ServiceType/ServiceTypeList";
import HardwareConfigurationList from "../pages/HardwareConfiguration/HardwareConfigurationList";
...
const authProtectedRoutes = [
  ...
  { path: "/technician-list", component: <TechnicianList /> },
  ...
  { path: "/repair-type-list", component: <RepairTypeList /> },
  { path: "/source-list", component: <SourceList /> },
  { path: "/device-model-list", component: <DeviceModelList /> },
