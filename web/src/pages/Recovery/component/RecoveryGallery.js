  ...
  return (
    <Row>
      <Col lg={12}>
        <Card className="mb-4">
          <CardBody>
            <h5 className="fs-15 mb-1">Recovery Gallery</h5>
            <p className="text-muted">Add Recovery Images (Optional).</p>
...
export default RecoveryGallery;