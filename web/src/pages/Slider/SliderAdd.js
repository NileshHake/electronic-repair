...
const SliderAdd = ({ isOpen, toggle }) => {
  ...
  const validate = () => {
    ...
    if (sliderDetails.slider_for_product === "0") {
      // NORMAL SLIDER VALIDATION
      if (!sliderDetails.pre_title_text)
        newErrors.pre_title_text = "Required";

      if (!sliderDetails.pre_title_price)
        newErrors.pre_title_price = "Required";

      if (!sliderDetails.title)
        newErrors.title = "Required";

      if (!sliderDetails.subtitle_text_1)
        newErrors.subtitle_text_1 = "Required";

      if (!sliderDetails.subtitle_percent)
        newErrors.subtitle_percent = "Required";

      if (!sliderDetails.subtitle_text_2)
        newErrors.subtitle_text_2 = "Required";
    }
    ...
    if (sliderDetails.slider_for_product === "1") {
      ...
      if (!sliderDetails.slider_old_price)
        newErrors.slider_old_price = "Required";

      if (!sliderDetails.pre_title_price)
        newErrors.pre_title_price = "Required";
      
      if (!sliderDetails.slider_bg_text)
        newErrors.slider_bg_text = "Required";
    }

    // IMAGE REQUIRED FOR BOTH
    if (!sliderDetails.slider_image)
